...
public class MainController {
	...
	public String userLogin(@RequestParam("email") String unameUI, @RequestParam("password") String passUI, Model model,
		...
		return accService.userLogin(unameUI, passUI, model, httpSession);
	}
	...
	public String uploadKYCDocs(@RequestParam("pancard") MultipartFile pancardfile,
			@RequestParam("aadharcard") MultipartFile aadharfile, HttpSession session, Model model) {
	...
	public String forgotPassword(@RequestParam("newPassword") String newPassword,
			@RequestParam("username") String username, @RequestParam("password") String oldPassword,
